...
const Aside = () => {
    ...
    return (
        ...
        className='pt-3 overflow-auto w-[60px] md:w-[260px] border-e fixed' style={{height:"100vh"}}>
            <div className='flex justify-center border-b pb-2'>
                <div>
                    <img src={img1} alt="" className='mx-auto w-10 h-10 md:w-20 md:h-20  border border-gray-800 
                    rounded-full object-cover'/>
                    <h2 className='font-medium text-[17px] mt-1 text-center  hidden md:block'>Mohnad Elgaid</h2>
